...
class ProfileScreenSpeaker extends StatefulWidget {
  const ProfileScreenSpeaker({super.key, required this.user});
  final ChatUser user;
  @override
  State<ProfileScreenSpeaker> createState() => _ProfileScreenSpeakerState();
}

class _ProfileScreenSpeakerState extends State<ProfileScreenSpeaker> {
  ...
  // void getInfo(Speaker speaker) async {
  //   await FirebaseServices.getSpeakerInfo(speaker);
  // }

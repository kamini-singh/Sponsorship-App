...
class ProfileScreenSponsorOrg extends StatefulWidget {
  const ProfileScreenSponsorOrg({super.key, required this.user});
  final ChatUser user;
  @override
  State<ProfileScreenSponsorOrg> createState() => _ProfileScreenSponsorOrgState();
}

class _ProfileScreenSponsorOrgState extends State<ProfileScreenSponsorOrg> {
  //late SpeakerOrg speakerOrg;
  String _image = '';
  ...
  //   getInfo(speakerOrg);
  // }
  // void getInfo(SpeakerOrg speakerOrg)
  // async{
  //   await FirebaseServices.getSpeakerOrgInfo(speakerOrg);
  // }
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        //   cursorColor: Colors.black,
                        //   decoration: const InputDecoration(
                        //     hintText: 'Student Club which conducts technical events',
                        //     border: UnderlineInputBorder(),
                        //     focusColor: Colors.black,
                        //     hoverColor: Colors.black,
                        //   ),
